    ...
    <form class="form-horizontal" action="" method="post">
        ...
        <div id="login-footer">
            <span id="forgot-password-link">
                <i class="icon ion-help-circled"></i> <a href="{{URL::route('forgot-password')}}">{{trans('user.forgot-password')}}</a>
            </span>
            <input class="btn btn-danger no-radius pull-right" type="submit" value="Login"/>
        </div>
    </form>
