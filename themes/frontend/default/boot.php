...
Theme::asset()->add('style-v5-css', 'theme/css/style-v5.css');
Theme::asset()->add('style-v5.2-css', 'theme/css/style-v5.2.css');
Theme::asset()->add('custom-css', 'theme/css/custom.css');

/**Javascript**/
Theme::asset()->add('jquery', 'theme/js/jquery.js');
Theme::asset()->add('jquery-ui', 'theme/js/jquery-ui.js');
