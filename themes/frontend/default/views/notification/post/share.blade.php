<div class="user media user-mini notification {{$notification->id}}-notification">
      ...
      <div class="media-body">
           <h5 class="media-heading">
               ...
               <a href="{{$notification->user->present()->url()}}">{{$notification->user->fullname}} </a> {{trans('notification.share-your')}} <a data-ajaxify="true" href="{{URL::route('post-page', ['id' => $post->id])}}">{{trans('post.post')}}</a>
           </h5>
